...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     */
    public void setCustomTabView(int layoutResId, int layoutResIdRight, int textViewId) {
        mTabViewLayoutId = layoutResId;
        mLayoutResIdRight = layoutResIdRight;
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (i == 0) {//左边tab
                ...
                if (mTabViewLayoutId != 0) {
                    // If there is a custom tab view layout id set, try and inflate it
                    tabView = LayoutInflater.from(getContext()).inflate(mLayoutResIdRight, mTabStrip,
                            false);
                    tabTitleView = (TextView) tabView.findViewById(mTabViewTextViewId);
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == 0) {
                TextView tv_left = mTabTitleViews.get(position);
                TextView tv_right = mTabTitleViews.get(position + 1);
                tv_left.setSelected(true);
                tv_right.setSelected(false);
                tv_left.setTextColor(getResources().getColor(R.color.white));
                tv_right.setTextColor(getResources().getColor(R.color.text_gray));
//                tv_left .setBackgroundResource(R.drawable.dialog_shape);
//                tv_left.setTextColor(getResources().getColor(R.color.white));
//                tv_right .setBackgroundColor(R.drawable.dialog_shape_right);
//                tv_right.setTextColor(getResources().getColor(R.color.text_gray));
            } else if (position == 1) {
                TextView tv_right = mTabTitleViews.get(position);
                TextView tv_left = mTabTitleViews.get(position - 1);
                tv_left.setSelected(false);
                tv_right.setSelected(true);
//                tv_left .setBackgroundColor(getResources().getColor(R.color.white));
                tv_left.setTextColor(getResources().getColor(R.color.text_gray));
//                tv_right .setBackgroundColor(getResources().getColor(R.color.text_blue));
