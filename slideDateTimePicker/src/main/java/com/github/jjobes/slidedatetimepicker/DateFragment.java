...
public class DateFragment extends Fragment
{
    ...
    private static DateChangedListener mCallback;
    ...
    public   void  setOnDateChangeListenner(DateFragment.DateChangedListener timeChangeListenner){
...
//        }
    ...
    public static final DateFragment newInstance(int theme, int year, int month,
                                                 int day, Date minDate, Date maxDate,DateFragment.DateChangedListener timeChangeListenner)
    {
