...
public class TXFeedAd extends AdWatcher {
    ...
    public TXFeedAd(Activity activity, String appid, String adid, FrameLayout frameLayout) {
        this.mActivity=activity;
        this.mAdId=adid;
        this.mFeedContainer=frameLayout;
        GDTAdSdk.init(activity.getApplication(), appid);
    }
    ...
    public void showAd() {
        ...
        nativeExpressAD = new NativeExpressAD(mActivity, new ADSize(ADSize.FULL_WIDTH, ADSize.AUTO_HEIGHT),mAdId, new NativeExpressAD.NativeExpressADListener() {
            @Override
