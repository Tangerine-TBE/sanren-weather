...
public class TimeFragment extends Fragment
{
    ...
    private  static TimeChangedListener mCallback;
    ...
    public   void  setOnTimeChangeListenner(TimeChangedListener timeChangeListenner){
...
//        }
    ...
    public static final TimeFragment newInstance(int theme, int hour, int minute,
                                                 boolean isClientSpecified24HourTime, boolean is24HourTime,TimeChangedListener timeChangeListenner)
    {
