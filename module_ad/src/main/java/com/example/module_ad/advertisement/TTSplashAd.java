...
public class TTSplashAd extends AdWatcher {
    ...
    public TTSplashAd(Activity activity, String codeId, FrameLayout frameLayout, boolean isClose, Class aClass) {
    ...
    public void showAd() {
        ...
        int screenWidth = RxDeviceTool.getScreenWidth(mActivity);
